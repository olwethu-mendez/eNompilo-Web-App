...
namespace eNompilo.v3._0._1.Migrations
{
    ...
    [Migration("20231107141522_addedAppointments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Counselling.AddResources", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Family_Planning.Condition", b =>
                {
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Family_Planning.Contraceptive", b =>
                {
                    b.Property<int>("ContraceptiveId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ContraceptiveId"), 1L, 1);

                    b.Property<string>("ContraceptiveDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ContraceptiveDuration")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ContraceptiveId");

                    b.ToTable("Contraceptive");
                });

            modelBuilder.Entity("eNompilo.v3._0._1.Models.Family_Planning.ContraceptiveBooking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SelectedContraceptive")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ContraceptiveBooking");
                });
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Family_Planning.FamilyPlanningAppointment", b =>
                {
                    ...
                    b.Property<string>("ResponsiblePractitionerId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Family_Planning.SelectDates", b =>
                {
                    ...
                    b.ToTable("SelectDates");
                });

            modelBuilder.Entity("eNompilo.v3._0._1.Models.Family_Planning.SelectedCondition", b =>
                {
                    b.Property<int>("SelectedConditionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SelectedConditionID"), 1L, 1);
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.GBV.GbvRecommendations", b =>
                {
                    ...
                    b.Property<string>("PractitionerRecommendation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Message.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Session", b =>
                {
                    ...
                    b.Property<int?>("CounsellingAppointmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CounsellingAppointmentId");

                    b.HasIndex("FamilyPlanningAppointmentId");

                    b.HasIndex("GeneralAppointmentId");
            ...
            modelBuilder.Entity("eNompilo.v3._0._1.Models.Session", b =>
                {
                    b.HasOne("eNompilo.v3._0._1.Models.Counselling.CounsellingAppointment", "CounsellingAppointment")
                        .WithMany()
                        .HasForeignKey("CounsellingAppointmentId");

                    b.HasOne("eNompilo.v3._0._1.Models.Family_Planning.FamilyPlanningAppointment", "FamilyPlanningAppointment")
                        .WithMany()
                        .HasForeignKey("FamilyPlanningAppointmentId");

                    b.HasOne("eNompilo.v3._0._1.Models.GeneralAppointment", "GeneralAppointment")
                        .WithMany()
                        .HasForeignKey("GeneralAppointmentId");
                    ...
                    b.HasOne("eNompilo.v3._0._1.Models.Vaccination.VaccinationAppointment", "VaccinationAppointment")
                        .WithMany()
                        .HasForeignKey("VaccinationAppointmentId");

                    b.Navigation("CounsellingAppointment");

                    b.Navigation("FamilyPlanningAppointment");

                    b.Navigation("GeneralAppointment");
